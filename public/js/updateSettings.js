...
if (staticForm) {
    ...
    staticForm.addEventListener('submit', async(event) => {
        ...
        try {
            ...
            newData.firstName = firstName.value;
        }
        catch (e) {
        ...
        try {
            ...
            if (showGender.checked) newData.showGender = "on";
            else newData.showGender = "off";
        }
        catch (e) {
            const message = typeof e === 'string' ? e : e.message;
            errorTextElement.textContent = `Error: ${message}`;
        ...
        try {
            ...
            newData.pronouns = pronouns.value;
        }
        catch (e) {
            const message = typeof e === 'string' ? e : e.message;
            errorTextElement.textContent = `Error: ${message}`;
        ...
        try {
            ...
            if (showPronouns.checked) newData.showPronouns = "on";
            else newData.showPronouns = "off";
        }
        catch (e) {
            const message = typeof e === 'string' ? e : e.message;
            errorTextElement.textContent = `Error: ${message}`;
        ...
        try {
            ...
            newData.interests = interestsValue;
        } catch (e) {
            const message = typeof e === 'string' ? e : e.message;
            errorTextElement.textContent = `Error: ${message}`;
            errorContainer.classList.remove('hidden');
        ...
        try {
            let res = await axios.patch(`/users/settings`, newData);
